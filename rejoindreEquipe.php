...
$message = "<p>Bonjour " . $nomcreateur . ", un participant à la MMI LAN souhaite rejoindre votre équipe</p><p>" . $_POST['playerDesc'] . "</p><p>Pour accepter ou refuser sa demande, veuillez vous rendre sur <a href='https://mmilan-toulon.fr/mon_compte.php'>votre page Mon Compte du site de la MMI LAN</a> </p>";
$headers = 'From: MMI LAN 2023 <mmilan.com2023@gmail.com>' . "\r\n" .
    'Reply-To: From: MMI LAN 2023 <mmilan.com2023@gmail.com>' . "\r\n" .
