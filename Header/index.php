...
<body>
    ...
    <div class="main">
        <div id="div_logo">
            <a href=""><img src="./img/logo.png" alt="logo mmilan" id="logo"></a>
        </div>
        <div class="rubriques">
        ...
        <div class="compte"><a href=""><img id="icon_compte" src="./img/compte.png" alt="icone de compte"></a></div>
        <div id="burger">
            <div id="bouton_burger">
                <div class="steak"></div>
                <div class="steak"></div>
                <div class="steak"></div>
                <div id="fermer"><img id="croix_fermer" src="./img/fermer.png" alt=""></div>
