    ...
    <div id="main">
      ...
      <form action="" method="POST">
        ...
        <div class="formulaire">
          ...
          <textarea name="infos" placeholder="Laisser un message ou des informations sur la zone de prise en charge" required></textarea>
          <p><i>En conduisant vos camarades à la LAN, vous vous engagez à veiller à le ramener ou à vous arranger qu’il soit ramené !</i></p>
          <?php
            session_start();
