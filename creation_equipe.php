        ...
        <div>
            ...
            <div id="formulaire">
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    $teamName = $_POST['nom'];
                    $teamDesc = $_POST['desc_equipe'];
                    $playerOneId = $_POST['joueur_un'];
                    $playerTwoId = $_POST['joueur_deux'];
                    $creatorDesc = $_POST['desc_createur'];
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <select name="joueur_un" id="joueur_un" required><br><br>
                    ...
                    <textarea placeholder="Écrire une description de l’équipe" name="desc_equipe" id="desc_equipe" cols="30" rows="10" required></textarea><br>
                    <textarea placeholder="Écrire une description de vous" name="desc_createur" id="desc_createur" cols="30" rows="10" required></textarea><br>
