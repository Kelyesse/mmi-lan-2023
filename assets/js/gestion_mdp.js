$(document).ready(function () {
    ...
    function validatePassword(password, confirmPassword) {
        ...
        return (
            hasMinLength && hasLowerCase && hasUpperCase && hasDigit && isMatch
        )
    }
    ...
    $("form").submit(function (event) {
        ...
        if (!validatePassword(passwordValue, confirmPasswordValue)) {
            ...
            $(".error-message").text(
                "Le mot de passe doit respecter les conditions, et les champs de mot de passe doivent correspondre."
            )
            document
                .querySelector("#title")
